...
export default function ForearmsPage() {
  // Get user session
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-neutral-950">
        <div className="text-center">
          <h2 className="text-white text-xl font-medium mb-1">Forearms Tracker</h2>
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white p-6 md:p-8">
      <div className="max-w-xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-2xl font-medium mb-1">Forearms</h1>
        ...
        <div className="space-y-2">
          {forearmsExercises.map((exercise) => (
            <div key={exercise}>
              {/* Exercise Button */}
              <button
