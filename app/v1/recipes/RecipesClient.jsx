...
function RecipeDetail({ recipe, onBack, onRegenerate, isGenerating }) {
  ...
  return (
    ...
    >
      ...
      {tab === "ingredients" && (
        <Card
          style={{ padding: "1rem 1.25rem", animation: "fadeIn 0.25s ease" }}
        >
            ...
            {recipe.ingredients?.map((ing, i) => (
              <div
                ...
                style={{
                  ...
                  justifyContent: "space-between",
                  alignItems: "center",
                  paddingBottom: i < recipe.ingredients.length - 1 ? 8 : 0,
                  borderBottom:
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          ...
          <span style={{ fontSize: 10, color: "#aaa" }}>
            {fmt(recipe.macros?.calories)} kcal
          </span>
          <span style={{ fontSize: 10, color: "#ccc" }}>·</span>
          <span style={{ fontSize: 10, color: "#aaa" }}>
            {totalTime(recipe)}m
    ...
    <div style={{ position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            <div>
              <p style={{ fontSize: 12, color: "#aaa", fontWeight: 400 }}>
                AI-powered
              </p>
              <h1
                style={{
          ...
          {!isShowingDetail && mainTab === "find" && (
            ...
            >
              ...
              <div>
                ...
                {selected.length === 0 ? (
                  ...
                  >
                    ...
                    <p style={{ fontSize: 13, color: "#bbb", fontWeight: 500 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 11, color: "#ccc", marginTop: 5 }}>
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            color: "#ccc",
                            transform:
                              openCat === ci ? "rotate(90deg)" : "rotate(0deg)",
              ...
              {error && (
                <p style={{ fontSize: 12, color: "#e53e3e", fontWeight: 600 }}>
                  ⚠️ {error}
                </p>
              )}
              ...
              {source && recipe && (
                <p style={{ fontSize: 11, color: "#aaa", textAlign: "center" }}>
                  {source === "db"
                    ? "⚡ Found in library instantly"
                    : "✨ Generated by AI & saved for next time"}
                </p>
              )}
            </div>
          )}
          ...
          {!isShowingDetail && mainTab === "library" && (
            ...
            >
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <select
                  value={libGoal}
                  onChange={(e) => setLibGoal(e.target.value)}
                  style={{
                    flex: 1,
                ...
                <select
                  value={libMeal}
                  onChange={(e) => setLibMeal(e.target.value)}
                  style={{
                    flex: 1,
                    padding: "0.6rem 0.8rem",
                    borderRadius: 12,
              ...
              {libLoading ? (
                ...
                <Card style={{ textAlign: "center", padding: "2.5rem 1.5rem" }}>
                  ...
                  <p style={{ fontSize: 13, color: "#aaa", lineHeight: 1.6 }}>
                    Import the seed JSON into Atlas, or generate recipes from
                    the Find tab.
                  </p>
                </Card>
              ) : (
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      fontSize: 13,
                      fontWeight: 700,
                      color: libPage <= 1 ? "#ccc" : "#1a1a1a",
                      fontFamily: "inherit",
                      cursor: libPage <= 1 ? "not-allowed" : "pointer",
                    }}
                  >
                    ← Prev
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontSize: 13,
                      fontWeight: 700,
                      color: libPage >= libPages ? "#ccc" : "#1a1a1a",
                      fontFamily: "inherit",
                      cursor: libPage >= libPages ? "not-allowed" : "pointer",
                    }}
                  >
                    Next →
                  </button>
