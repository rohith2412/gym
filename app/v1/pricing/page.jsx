  ...
  return (
    <main style={{ padding: "1.25rem 1.25rem 3rem", flex: 1, display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <p style={{ fontSize: 11, color: "#bbb", textAlign: "center", lineHeight: 1.6 }}>
        Secured by Stripe. Cancel any time from your profile page.
      </p>
    </main>
  );
}
  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <button
          onClick={() => router.back()}
          style={{ width: 36, height: 36, border: "1px solid #e8e5de", background: "#fff", borderRadius: 10, fontSize: 18, display: "flex", alignItems: "center", justifyContent: "center", color: "#1a1a1a", cursor: "pointer" }}
        >←</button>
