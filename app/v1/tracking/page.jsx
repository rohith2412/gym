...
function YearContributionChart({ logs }) {
  ...
  return (
    <div className="" style={{ marginTop: 14 }}>
      {/* Mini stats row */}
      <div  className="" style={{ display: "flex", gap: 10, marginBottom: 12 }}>
        {[
      ...
      >
        {/* Wrapper ensures same width for labels + grid */}
        ...
        >
          {allExercises.map((ex, i) => (
            <div key={i}>
              ...
              {i < allExercises.length - 1 && (
                <div
                  style={{ height: 1, background: "#f0ede8", marginTop: 10 }}
                />
              )}
            </div>
          ))}
      ...
      {!fetching && last && (
        <>
          ...
          >
            ...
            <div
              style={{ width: 1, background: "#e8e5de", margin: "0 1.1rem" }}
            />
            <div
              style={{
                flex: 1,
            ...
            >
              ...
              <DeltaBadge
                delta={last.volumeDelta}
                neutral={last.improved === null}
              />
            </div>
          </Card>
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: 800,
                      lineHeight: 1.1,
                      color: i === data.length - 1 ? "#fff" : "#1a1a1a",
                    }}
                  >
            ...
            return (
              ...
              >
                ...
                {isAdded ? (
                  ...
                  <span
                    style={{ fontSize: 16, color: "#ff6b35", fontWeight: 800 }}
                  >
                    ✓
                  </span>
                ) : (
                  <span style={{ fontSize: 20, color: "#ccc", lineHeight: 1 }}>
                    +
                  </span>
                )}
              </button>
  ...
  const weekVolume = logs
    ...
    .reduce(
      (s, l) =>
        ...
        l.exercises.reduce(
          (sum, ex) =>
            sum + ex.sets.reduce((a, set) => a + set.reps * set.weight, 0),
          0,
        ),
      0,
    );
      ...
      >
        ...
        {!loadingLogs && (
          <div
            ...
            style={{ paddingBottom: "0.85rem", cursor: "pointer" }}
          >
            {/* Stats row */}
            <div
              style={{
        ...
        {!showLog && (
          <div
            style={{
              ...
              background:
                "linear-gradient(to top, rgba(250,250,248,1) 60%, rgba(250,250,248,0))",
              pointerEvents: "none",
            }}
          >
            <button
